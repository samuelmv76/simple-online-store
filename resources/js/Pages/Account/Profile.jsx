...
const userSchema = object({
    ...
    email: string().required('El correo electronico es requerido').email('Debe ingresar un correo electronico válido')
});
...
export default function Profile() {
    ...
    const checkInput = (errors, touched, name) => {
        if (touched[name]) return errors[name] ? 'border border-danger' : ''
    }
    ...
    return (
        <div className="d-flex justify-content-center">
            <div className="p-4 rounded shadow text-center mt-4">
                ...
                {showProfile && (
                    <div className="my-3">
                        <h2 className="fs-4 mb-0">{user.name} {user.surname}</h2>
